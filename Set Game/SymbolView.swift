...
class SymbolView: UIView {
    ...
    var orientation = Orientation.vertical { didSet { setNeedsDisplay(); setNeedsLayout()} }
    
    var symbol = SymbolType.diamond { didSet { setNeedsDisplay(); setNeedsLayout()} }

    var shading = Shading.striped { didSet { setNeedsDisplay(); setNeedsLayout() } }

    var color = UIColor.blue { didSet { setNeedsDisplay(); setNeedsLayout() } }
